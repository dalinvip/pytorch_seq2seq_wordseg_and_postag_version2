...
def dalaloader(args):
    ...
    create_alphabet = Create_Alphabet(min_freq=args.min_freq, word_min_freq=args.word_min_freq,
                                      ...
                                      char_embedding_path=args.char_Embedding_path,
                                      bichar_embedding_path=args.bichar_Embedding_Path)
...
args.static_embed_char_num = create_alphabet.static_char_alphabet.m_size
args.static_embed_bichar_num = create_alphabet.static_bichar_alphabet.m_size
...
args.create_static_alphabet = create_alphabet
