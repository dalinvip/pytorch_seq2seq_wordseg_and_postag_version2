...
class Create_Alphabet():
    def __init__(self, min_freq=1, word_min_freq=1, char_min_freq=1, bichar_min_freq=1,
                 char_embedding_path=None, bichar_embedding_path=None ):

        self.char_embedding_path = char_embedding_path
        self.bichar_embedding_path = bichar_embedding_path
        ...
        self.static_char_alphabet = Alphabet(min_freq=1)
    ...
    def createAlphabet(self, train_data=None, dev_data=None, test_data=None, debug_index=-1):
        ...
        self.static_char_alphabet.initial_from_pretrain(self.char_embedding_path, unkkey, paddingkey)
        self.static_bichar_alphabet.initial_from_pretrain(self.bichar_embedding_path, unkkey, paddingkey)
        ...
        self.static_char_UnkID = self.static_char_alphabet.loadWord2idAndId2Word(unkkey)
        self.static_bichar_UnkID = self.static_bichar_alphabet.loadWord2idAndId2Word(unkkey)
        ...
        self.static_char_PaddingID = self.static_char_alphabet.loadWord2idAndId2Word(paddingkey)
        self.static_bichar_PaddingID = self.static_bichar_alphabet.loadWord2idAndId2Word(paddingkey)
        ...
        self.static_char_alphabet.set_fixed_flag(True)
        self.static_bichar_alphabet.set_fixed_flag(True)
